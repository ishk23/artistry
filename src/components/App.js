...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const portis = new Portis('f2505ed2-81f6-4d85-a75b-2b92b835e9cf', myPrivateEthereumNode);
    ...
    if (networkData) {
      ...
      //orders the tips according to tipped amount
      this.setState({
  ...
  render() {
    return (
      <div>
        ...
        { this.state.loading
          ? <div id="loader" className="text-center mt-15"><p>Loading...</p></div>
          : <Main
